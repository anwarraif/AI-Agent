# agents/sql_agent.py
from app_v2.sql.toolkit import tools, db
...
_sql_agent = create_react_agent(llm, tools, state_modifier=system_message)
...
class SQLAgentWrapper:
    ...
    def invoke(self, query: str):
        try:
            ...
            return {
                "answer": answer,
                "sql_preview": "SQL query executed via agent",
                "sql_result": answer,
                "sources": []
            }
...
sql_agent = SQLAgentWrapper(_sql_agent)
